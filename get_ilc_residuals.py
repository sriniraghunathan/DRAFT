...
if include_gal:
    gal_sim_bands = [27, 39, 93, 145, 225, 278]  #Hardcoded for now, could also load the relevant npy file here already rather than later
...
for TPcntr, TP in enumerate( TParr ):
    ...
    for freq1 in freqarr:
        ...
        for freq2 in freqarr:
            ...
            if expname == 's4deepv3r025_plus_s4wide' and np.sum(nl) > 0. and freq1 in specs_dic_s4wide and freq2 in specs_dic_s4wide: #20210428: inv. var. combination of S4-Wide and S4-Ultra deep nl
...
if include_gal:
    ...
    #Unreachable inside if include_gal
    #if not include_gal:
    #    fsky_val = 0.68
    #else:
