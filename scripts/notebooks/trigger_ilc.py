        ...
        for lmh in lf_to_mf_hf_arr:
            for mlh in mf_to_lf_hf_arr:
                for hlm in hf_to_lf_mf_arr:
                    ...
                    cmd = 'python %s -lf_to_mf %s -lf_to_hf %s -mf_to_lf %s -mf_to_hf %s -hf_to_lf %s -hf_to_mf %s -also_te %s -which_gal_mask %s ' %(pgmname, lf_to_mf, lf_to_hf, mf_to_lf, mf_to_hf, hf_to_lf, hf_to_mf, also_te, which_gal_mask)
                    print('\n###############\n%s\n' %(cmd))
                    os.system(cmd)
sys.exit()
