...
parser.add_argument('-use_mdpl2_cib', dest='use_mdpl2_cib', action='store', help='use_mdpl2_cib', type = int, default=0)
...
if use_websky_cib:
    ...
    parent_folder = 'results/spt/20200708/mdpl2_cib/'
elif use_545:
